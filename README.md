...
- `METERIAN_MACHINE_USER` - this is the machine user account created by yourself (learn more about machine user creation at [GitHub: developer guides | machine-users](https://developer.github.com/v3/guides/managing-deploy-keys/#machine-users)), follow the steps mentioned in the link (default: meterian-bot)
- `METERIAN_MACHINE_USER_EMAIL` - this is the email address associated with the machine user account created in the previous step (default: bot.github@meterian.io)
